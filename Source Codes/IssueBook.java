...
public class IssueBook extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("service_id");
	...
	JLabel l3 = new JLabel("Aadhar No.");
	...
	JLabel l7 = new JLabel("Daily w/hr");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Book-Service",
	...
	JLabel l15 = new JLabel(" Date of Booking :");
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    t3.setText(rs.getString("aadhar"));
                    t4.setText(rs.getString("city"));
                    t5.setText(rs.getString("services"));
                    t6.setText(rs.getString("price"));
                    t7.setText(rs.getString("dailyhr"));
		}
		st.close();
		rs.close();
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    t9.setText(rs.getString("username"));
                    t10.setText(rs.getString("aadhar"));
                    t11.setText(rs.getString("services"));
                    t12.setText(rs.getString("price"));
                    t13.setText(rs.getString("time"));
                    t14.setText(rs.getString("city"));
		}
		st.close();
		rs.close();
            ...
            if(ae.getSource() == b3){
                    try{
                String sql = "insert into bookService(service_id, user_id, bname, sname, services, price, dateOfBooking) values(?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, t1.getText());
