...
public class AddStudent extends JFrame implements ActionListener{
	...
	JLabel l4 = new JLabel("Price Range");
	l4.setForeground(new Color(25, 25, 112));
	l4.setFont(new Font("Tahoma", Font.BOLD, 14));
	l4.setBounds(64, 209, 102, 22);
	contentPane.add(l4);

        JLabel l5 = new JLabel("Time Period");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Rs.500-Rs.1000", "Rs.1000-Rs.2000", "Rs.2000-Rs.3000", "Rs.3000-Rs.4000", "Rs.4000-Rs.5000", "Rs.5000-Rs.10000" }));
	...
	comboBox_1.setModel(new DefaultComboBoxModel(new String[] { "1 Day", "1 Week", "1 Month", "6 Month", "1 Year", "Other" }));
	...
	comboBox_2.setModel(
			new DefaultComboBoxModel(new String[] { "New Delhi", "Mumbai", "Jaipur", "Pune", "Hyderabad", "Noida", "Kolkata", "Lucknow", "ahemdabad", "Bangalore", "Chandigarh", "Srinagar", "Shimla", "Dehdradun" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "Cooking", "Washing dishes", "Laundry", "House Cleaning", "Bathroom Cleaning", "Other" }));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into user(user_id, username, aadhar, services, price, time, city) values(?, ?, ?, ?, ?, ?, ?)";
