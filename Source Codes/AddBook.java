...
public class AddBook extends JFrame implements ActionListener{
	...
	JLabel l2 = new JLabel("Aadhar No.");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Cooking", "Washing Dishes", "laundry", "House Cleaning", "Full-time maid", "Bathroom Cleaning", "Other" }));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Service", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into service(service_id, name, aadhar, city, services, price, dailyhr) values(?, ?, ?, ?, ?, ?, ?)";
