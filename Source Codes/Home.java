...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            JLabel l1 = new JLabel("Maid In India");
            l1.setForeground(new Color(204, 70, 102));
            l1.setFont(new Font("Segoe UI Semilight", Font.BOLD, 50));
            l1.setBounds(268, 30, 701, 80);
            contentPane.add(l1);

            JLabel l2 = new JLabel("");
            l2.setVerticalAlignment(SwingConstants.TOP);
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/second.png"));
            Image i2 = i1.getImage().getScaledInstance(140, 140,Image.SCALE_DEFAULT);
            ImageIcon i3 = new ImageIcon(i2);
            l2 = new JLabel(i3);
            l2.setBounds(60, 140, 159, 160);
            contentPane.add(l2);

            JLabel l3 = new JLabel("");
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/third.jpg"));
            ...
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/fourth.png"));
            Image i8 = i7.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i9 = new ImageIcon(i8);
            l4 = new JLabel(i9);
            l4.setBounds(535, 140, 225, 164);
            contentPane.add(l4);

            b1 = new JButton("Add Service");
            ...
            b5 = new JButton("Withdraw Service");
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/fifth.png"));
            Image i11 = i10.getImage().getScaledInstance(140, 140,Image.SCALE_DEFAULT);
            ImageIcon i12 = new ImageIcon(i11);
            l5 = new JLabel(i12);
            l5.setBounds(65, 440, 159, 163);
            contentPane.add(l5);

            JLabel l6 = new JLabel("");
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/sixth.png"));
            Image i14 = i13.getImage().getScaledInstance(140, 140,Image.SCALE_DEFAULT);
            ImageIcon i15 = new ImageIcon(i14);
            l6 = new JLabel(i15);
            l6.setBounds(320, 445, 140, 152);
            contentPane.add(l6);

            JLabel l7 = new JLabel("");
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("dtiproject/icons/seventh.png"));
            Image i17 = i16.getImage().getScaledInstance(140, 140,Image.SCALE_DEFAULT);
